...
import (
	...
	internal "bookem-rating-service/internal"
...
func main() {
	...
	ratingRepo := internal.NewRepository(dB)

	service := internal.NewService(ratingRepo, userClient, roomClient, reservationClient, notificationClient)
